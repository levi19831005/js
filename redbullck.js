...
注意事项 ： 运行js时不要打开软件app
获取ck：  
重写：https://redbullapi.rrfenwo.com/wechat/getUserInfo
https://raw.githubusercontent.com/levi19831005/js/main/redbullck.js
主机名：redbullapi.rrfenwo.com
*/
const $ = new Env("红牛wx获取Ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.redbullck : $.getdata('redbullck')) || '';  //设定变量名称redbullck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
