...
软件：  开小灶获取ck
获取ck：  打开小程序即可------
重写：https://202210kaixiaozao.iwxapi.com/api/activity/Index/lists
      url script-request-body
      https://raw.githubusercontent.com/levi19831005/js/main/S_kxxzflncCk.js
主机：202210kaixiaozao.iwxapi.com
boxjs订阅：https://raw.githubusercontent.com/levi19831005/js/main/levi19831005.boxjs.json
*/
const $ = new Env("开小灶获取Ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.S_kxxzflncCk : $.getdata('S_kxxzflncCk')) || '';  //设定变量名称S_kxxzflncCk
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
...
////////////////////qx获取重写的链接中的关键词 https://202210kaixiaozao.iwxapi.com/api/activity/Index/lists
async function GetRewrite() {
    if($request.url.indexOf(`Index/lists`) > -1) {
