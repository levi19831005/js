...
软件：  金典SATINE签到获取ck
获取ck：  打开小程序------
重写：https://jdshop.yili.com/api/user/level/info url script-request-header https://raw.githubusercontent.com/levi19831005/js/main/jdqdck.js
主机名：jdshop.yili.com
*/
const $ = new Env("金典签到获取Ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.jdqdck : $.getdata('jdqdck')) || '';  //设定变量名称jdqdck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
...
////////////////////qx获取重写的链接中的关键词 https://jdshop.yili.com/api/user/level/info
async function GetRewrite() {
    if($request.url.indexOf(`level/info`) > -1) {
