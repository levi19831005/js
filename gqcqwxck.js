...
let userCookie = ($.isNode() ? process.env.gqcqwxck : $.getdata('gqcqwxck')) || '';  //设定变量名称gqcqwxck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
...
////////////////////qx获取重写的链接中的关键词 https://mall.gacmotor.com/center-current-app/fronted/myHomePage/myInfo
async function GetRewrite() {
    if($request.url.indexOf(`myHomePage/myInfo`) > -1) {
