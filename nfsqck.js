...
注意事项 ： 
获取ck：  
重写：https://nfsq.lookcharm.cn/game1/getaddr
https://raw.githubusercontent.com/levi19831005/js/main/nfsqck.js
主机名：redbullapi.rrfenwo.com
boxjs订阅地址：https://raw.githubusercontent.com/levi19831005/js/main/levi19831005.boxjs.json
*/
const $ = new Env("农夫山泉小程序获取Ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.nfsqck : $.getdata('nfsqck')) || '';  //设定nfsq称nfsqck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
