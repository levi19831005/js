...
软件：  卡夫享小程序获取ck
获取ck：  打开小程序即可------
重写：https://fscrm.kraftheinz.net.cn/crm/public/index.php/api/v1/getUserInfo
      url script-request-header 
      https://raw.githubusercontent.com/levi19831005/js/main/kfxck.js
主机：fscrm.kraftheinz.net.cn
boxjs订阅：https://raw.githubusercontent.com/levi19831005/js/main/levi19831005.boxjs.json
*/
const $ = new Env("卡夫享获取Ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.kfxck : $.getdata('kfxck')) || '';  //设定变量名称kfxck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
...
////////////////////qx获取重写的链接中的关键词 https://fscrm.kraftheinz.net.cn/crm/public/index.php/api/v1/getUserInfo
