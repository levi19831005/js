...
软件：  悦马星空获取ck
获取ck：  打开即可------
重写：https://appapi.changan-mazda.com.cn/api-user/openPage/app/openPage
      url script-request-header
      https://raw.githubusercontent.com/levi19831005/js/main/ymxkck.js
主机：appapi.changan-mazda.com.cn
boxjs订阅：https://raw.githubusercontent.com/levi19831005/js/main/levi19831005.boxjs.json
*/
const $ = new Env("悦马星空获取Ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.ymxkck : $.getdata('ymxkck')) || '';  //设定变量名称ymxkck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
...
////////////////////qx获取重写的链接中的关键词 https://appapi.changan-mazda.com.cn/api-user/openPage/app/openPage
async function GetRewrite() {
    if($request.url.indexOf(`openPage`) > -1) {
