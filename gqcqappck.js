...
*/
const $ = new Env("广汽传祺app获取Ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.gqcqappck : $.getdata('gqcqappck')) || '';  //设定变量名称gqcqappck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
...
////////////////////qx获取重写的链接中的关键词 https://gsp.gacmotor.com/gateway/app-api/my/message/myeachnumv2
