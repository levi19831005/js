...
软件：   统一茄皇ck
获取ck：  打开app即可------
重写：https://qiehuang-apig.xiaoyisz.com/qiehuangsecond/ga/public/api/login
      url script-request-body
      https://raw.githubusercontent.com/levi19831005/js/main/qhck.js
主机：qiehuang-apig.xiaoyisz.com
boxjs订阅：https://raw.githubusercontent.com/levi19831005/js/main/levi19831005.boxjs.json
*/
const $ = new Env(" 统一茄皇ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.qhck : $.getdata('qhck')) || '';  //设定变量名称qhck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
