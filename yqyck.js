...
软件：  优盈获取ck
获取ck：  打开软件即可------
重写：https://api.yqypt.com/v2/app/info url script-request-header https://raw.githubusercontent.com/levi19831005/js/main/yqyck.js
主机名：api.yqypt.com
*/
const $ = new Env("优企盈获取Ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.yqyck : $.getdata('yqyck')) || '';  //设定变量名称yqyck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
...
////////////////////qx获取重写的链接中的关键词 https://api.yqypt.com/v2/app/info
async function GetRewrite() {
    if($request.url.indexOf(`app/info`) > -1) {
