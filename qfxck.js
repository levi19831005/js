...
软件：  起飞线小程序获取ck
获取ck：  打开小程序即可------
重写：https://cluster.qifeixian.com/api/wallet/v1/member/account/info
      url script-request-header 
      https://raw.githubusercontent.com/levi19831005/js/main/qfxck.js
主机：cluster.qifeixian.com
boxjs订阅：https://raw.githubusercontent.com/levi19831005/js/main/levi19831005.boxjs.json
*/
const $ = new Env("起飞线获取Ck");

let envSplitor = ['\n']  //多账号隔开方式
let httpResult, httpReq, httpResp                                                                   ////这个不懂
let userCookie = ($.isNode() ? process.env.qfxck : $.getdata('qfxck')) || '';  //设定变量名称qfxck
let userList = []                                                                                   ////这个不懂
let userIdx = 0                                                                                     ////这个不懂
